	...
	<section class="tw-px-6 tw-py-24 tw-bg-gray-100">
		<div class="tw-container">
			<div class="tw-flex tw-flex-col lg:tw-flex-row">
				<div class="tw-full lg:tw-w-3/4 lg:tw-pr-4">
					<?php
						...
						<div class="tw-flex tw-flex-wrap">
							<?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
								<div class="tw-w-full md:tw-w-1/2 md:tw-px-4 tw-flex">
									<div class="tw-flex tw-flex-col tw-bg-white tw-rounded-2xl tw-mb-8 tw-shadow-lg tw-overflow-hidden">
										<div class="tw-flex-auto">
											...
											<div class="tw-p-8">
												<div class="tw-text-orange-600 tw-text-[28px] tw-font-semibold tw-leading-none tw-mb-8">
													<?php the_title(); ?>
												</div>
