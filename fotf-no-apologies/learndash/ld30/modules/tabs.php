...
$custom_css_classes = get_field('lms_quiz_css_class'); 
...
<div class="ld-tabs <?php echo esc_attr( 'ld-tab-count-' . $tab_count ); ?>">
	...
	<div class="ld-tabs-content">
		...
		foreach ( $tabs as $tab ) :
			...
			<div role="tabpanel" tabindex="0" aria-labelledby="<?php echo esc_attr( $tab['id'] ); ?>" class="<?= esc_attr( $tab_class ); ?> <?= $custom_css_classes; ?>" id="<?php echo esc_attr( 'ld-tab-' . $tab['id'] . '-' . get_the_ID() ); ?>">
