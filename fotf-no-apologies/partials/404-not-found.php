...
?>
<section class="px-5 text-center bg-yellow-100 z-10 relative <?php if ( in_array( 'group_leader', (array) $user->roles ) || in_array( 'subscriber', (array) $user->roles ) || in_array( 'administrator', (array) $user->roles ) ){ echo "pt-36 md:pt-80";} else{ echo("pt-36 md:pt-52 -mt-28 md:-mt-44");}?>">
