                    ...
                    <div class="large-7 columns main-banner__description">
                        ...
                        <div class="state-rank-and-score">
                            <div class="state-rank">
                                <span class="option">Rank:</span> <span class="option-value"><?php the_field('post_state_rank'); ?></span>
                            </div>

                            <div class="data-separator"></div>

                            <div class="state-score">
                                <span class="option">Score:</span> <span class="option-value"><?php the_field('post_state_score'); ?>%</span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="large-8 columns single-content">
                        ...
                        <div class="back-to-map">
                            <a href="<?php the_field('settings_single_state_back_button', 'option'); ?>">« Back to the map</a>
                        </div>
                    </div>
