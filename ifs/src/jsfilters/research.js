(function($){
  ...
  function ajaxArticlesCustom($postType) {
    var data = {
      action: 'get_initialArticles',
      cptname: $postType,
    };
  ...
  $(document).ready( function(){
    ...
    {
       case "blog":
        ajaxArticles($cptName, $option1, 30, 1);
        break;
       case "experts":
        ajaxArticles($cptName, $option1, 32, 1);
        break;
    }
    ...
    $('#first-option').on('change', function () {
      $option1 = $(this).val();
      if ( ($option1 == '' && $option2 == '') || ($option1 == null && $option2 == null) ) {
        ajaxArticlesCustom($cptName);
      }else{
