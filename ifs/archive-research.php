...
<?php
  $research_featured = get_field('research_featured','option');
  $banner_blog = get_field('research_banner','option');
...
?>
	...
	<div class="articles"> 
		...
		<?php if ( $research_featured ) : ?>
			<div class="destacada">
				<div class="row">
					<?php
						foreach ( $research_featured as $post) :
							setup_postdata($post);
