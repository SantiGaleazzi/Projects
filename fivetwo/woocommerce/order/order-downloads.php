...
<section class="woocommerce-order-downloads">
	...
	<table class="woocommerce-table woocommerce-table--order-downloads shop_table shop_table_responsive order_details stack">
		<thead>
			<tr>
				<?php foreach ( wc_get_account_downloads_columns() as $column_id => $column_name ) : ?>
					<?php if ($column_id != 'download-remaining' ): ?>
