...
task(
	'js',
	require('./gulp-tasks/scripts')(src, dest, gulpif, concat, uglify, configJS, env, browsersync)
)
task(
	'styles',
...
task('default', series('styles', 'js', 'fonts', 'serve'))

// Production Main Task Runner
task('production', series('styles', 'js', 'uncache'))
