<?php if ( check_range('01-12-2022', '31-12-2022') || ( isset($_GET['lightbox']) && $_GET['lightbox'] === 'dec-ye-2022' ) ) : ?>
		...
		<div class="lightbox-container">
			...
			<div class="lightbox-content">
				...
				<div class="lightbox-text">
					<span>We're raising $125K to launch more ministries that make an eternal difference.</span> For every $4 you give, 1 person meets Jesus.
				</div>
