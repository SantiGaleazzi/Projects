...
/**
 * addMetaImageUpload  Automatically set the image Title, Alt-Text, 
 * Caption & Description.
 * 
 * @param int|false The $postID of the current item in the WordPress Loop.
 */
function addMetaImageUpload($postID) 
{
...
add_action( 'add_attachment', 'addMetaImageUpload' );