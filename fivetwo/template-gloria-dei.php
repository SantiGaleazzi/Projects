...
<body <?php body_class(); ?> data-scroll>
        ...
        <div class="grid-container relative">
            ...
            <div class="grid-x grid-padding-x">
                ...
                <div class="cell large-6">
                    <div class="intro">
                        <h1 class="intro__title intro_gloria"><?php the_field('golf_invite_title'); ?></h1>
    ...
    <section class="golf-invite-form">
        ...
        <img src="<?php bloginfo('template_url'); ?>/assets/img/golf-invite/gloria-dei-bottom-bg.png" alt="Golf Field" class="golf-field">
