<?php
    ...
    $faculty_background_image = get_field('internships_faculty_image');
...
<section class="section-quoted block md:hidden">
    <div class="container">
        <div class="headline text-2xl md:text-3xl text-default font-roboto relative z-10 mx-auto">
            <?php the_field('internships_faculty_title'); ?>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="bg-page border-b-4 border-red-500 shadow-2xl">
            ...
            <div class="px-4 md:px-12 lg:px-24 -mt-24">
                <div class="bg-page">
                    <div class="px-6 md:px-12 py-24 md:py-32 bg-cover bg-center md:bg-right-top md:bg-contain bg-no-repeat relative" style="background-image: url('<?= $faculty_background_image['url']; ?>');">
                    ...
                    <div class="md:px-24 py-6 md:py-12 has-wysiwyg text-default has-red-links">
                        <?php the_field('internships_faculty_content'); ?>
                    </div>
                </div>
            </div>
        </div>
