...
<section class="pt-16 md:pt-40 xl:pt-40">
	<div class="container bg-black-500-new shadow-2xl border-b-4 border-red-500">
		<div class="text-white-pure px-6 md:px-12 lg:px-24 pt-10 lg:pt-16 pb-32 bg-red-500">
			<?php if ( isset( $_GET['from-churches'] ) ) : ?>
				< <a href="/for-churches" class="text-xs font-bold underline" >BACK TO CHURCHES</a>
			<?php elseif( ( isset( $_GET['from-get-inspired'] ) ) ) : ?>
				< <a href="/get-inspired" class="text-xs font-bold underline" >BACK TO GET INSPIRED</a>
			<?php else : ?>
				< <a href="/stories/<?= $filter_params ? '?applied-filters=' . $filter_params : '' ?>" class="text-xs font-bold underline" >BACK TO STORIES</a>
			<?php endif; ?>
		</div>
				...
				<div class="bg-page shadow-2xl mb-12">
					...
					<div class="text-xs text-red-500 font-bold px-6 sm:px-12 lg:px-24 py-6 md:py-10">
						...
						<?php elseif( ( isset( $_GET['from-get-inspired'] ) ) ) : ?>
							< <a href="/get-inspired" class="text-xs font-bold underline" >BACK TO GET INSPIRED</a>
						<?php else : ?>
							< <a href="/stories" class="text-xs font-bold underline" >BACK TO STORIES</a>
						<?php endif; ?>
					</div>
				</div>
				<!-- Post Copy -->
