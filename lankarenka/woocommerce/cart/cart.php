...
<div class="container px-6 py-12 md:py-20">
	...
	<div class="flex flex-col md:flex-row">
		...
		<div class="w-full md:w-2/3 md:pr-6">
			...
			<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
				...
				<div class="flex items-center justify-between mb-5">
					<h1 class="cart-has-products"><?php _e('Order', 'woocommerce'); ?></h1>
							...
							if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
								...
								<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
										<?= wc_get_product_category_list( $_product->get_id(), ', ', '<p class="category">' . _n( '', '', count( $_product->get_category_ids() ), 'woocommerce' ) . ' ', '</p>' ); ?>
										<?php
											if ( ! $product_permalink ) {
				...
				<div class="actions">
					...
					<h1 class="cart-has-coupon"><?php _e('Coupons', 'woocommerce'); ?></h1>
		...
		<div class="w-full md:w-1/3 md:pl-6">
			...
			<h1 class="payment-summary"><?php _e('Payment Summary', 'woocommerce'); ?></h1>
