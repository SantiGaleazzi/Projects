...
<div class="account">
	...
	<div class="flex items-center justify-between mb-3">
		<h1 class="text-3xl text-default font-normal">Payment Methods</h1>

		<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
			<a class="text-sm text-purple-100 leading-none px-5 py-3 bg-purple-500 rounded inline-block" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add', 'woocommerce' ); ?></a>
		<?php endif; ?>
	</div>
	...
	<?php else : ?>
		...
		<p class="woocommerce-Message woocommerce-Message--info woocommerce-info mb-4"><?php esc_html_e( 'No saved methods found.', 'woocommerce' ); ?></p>
